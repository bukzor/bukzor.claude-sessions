#!/bin/sh
# Method for 2026-09-16-006-volta-bundled-corepack-0-34-0-pnpm-range-table-catch-all-6-0-0-bin-pnpm-cjs-no-v11-v12-mjs-override.md -- re-runnable, and fair game to improve in place
