...
- `~/.claude/must-read.kb/before/asserting-or-conceding-a-claim-of-judgment.md` — protocol used for stress-test (renamed twice in 2026-08, most recently from `before/retracting-or-conceding-a-claim.md`; the Advocate/Skeptic/Arbiter stress-test is still the body).
